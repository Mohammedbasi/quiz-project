...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO subject(name,hours) VALUES('$name','$hours')";
                                            ...
                                            <div class="p-5">
                                                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="text" value="<?php isset($name) ? print($name) : '' ?>" name="name" class="form-control form-control-user" placeholder="Enter Subject Name">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number" min="1" max="5" value="<?php isset($hours) ? print($hours) : '' ?>" name="hours" class="form-control form-control-user" placeholder="Hours">
                                                        <?php
