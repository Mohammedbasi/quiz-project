...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO quiz(time,subjectId) VALUES('$time','$subject')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Quiz</h1>
                    <!-- Outer Row -->
                                            ...
                                            <div class="p-5">
                                                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="number" min="1" name="time" class="form-control form-control-user" placeholder="Enter Quiz Time">
                                                        <?php
