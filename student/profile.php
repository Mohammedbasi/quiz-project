...
if (!empty($_SESSION['stdLogin'])) {
    $emailSe = $_SESSION['stdEmail'];
    $conn = mysqli_connect('localhost', 'root', '', 'webProject');
    if (!$conn) {
        die("Error : " . mysqli_connect_errno());
    } else {
        $sql = "SELECT * FROM student WHERE email = '$emailSe'";
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                if (empty($errors)) {
                    $sql2 = "UPDATE student SET name = '$name',email = '$email',password = '$password' WHERE email = '$emailSe'";
                    if (mysqli_query($conn, $sql2)) {
                        $_SESSION['stdEmail'] = $email;
                        $_SESSION['stdPassword'] = $password;
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-md font-weight-bold text-info text-uppercase mb-1">email
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
